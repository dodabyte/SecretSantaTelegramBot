...
import static com.example.secretsantatelegrambot.util.MessageUtil.UPDATE_ROOM_WITH_MAX_COUNT_USERS_MESSAGE;

@Component
@RequiredArgsConstructor
public class UpdateRoomAwaitingMaxCountUsersHandler implements Handler {
    ...
    public List<PartialBotApiMethod<? extends Serializable>> handle(User user, Integer messageId, String message) {
        ...
        return updateHandler.getPartialBotApiMethods(user, messageId,
                UPDATE_ROOM_WITH_MAX_COUNT_USERS_MESSAGE.formatted(room.getMaxCountUsers()),
                UserState.AWAITING_UPDATE_MAX_COUNT_USERS_ROOM, roomId);
    }
    ...
    public List<String> operatedCallBackQuery() {
        return List.of(UPDATE_ROOM_MAX_COUNT_USERS_COMMAND);
    }
}