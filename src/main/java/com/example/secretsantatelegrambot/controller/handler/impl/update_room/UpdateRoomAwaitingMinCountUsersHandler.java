...
import static com.example.secretsantatelegrambot.util.MessageUtil.UPDATE_ROOM_WITH_MIN_COUNT_USERS_MESSAGE;

@Component
@RequiredArgsConstructor
public class UpdateRoomAwaitingMinCountUsersHandler implements Handler {
    ...
    public List<PartialBotApiMethod<? extends Serializable>> handle(User user, Integer messageId, String message) {
        ...
        return updateHandler.getPartialBotApiMethods(user, messageId,
                UPDATE_ROOM_WITH_MIN_COUNT_USERS_MESSAGE.formatted(room.getMinCountUsers()),
                UserState.AWAITING_UPDATE_MIN_COUNT_USERS_ROOM, roomId);
    }
    ...
    public List<String> operatedCallBackQuery() {
        return List.of(UPDATE_ROOM_MIN_COUNT_USERS_COMMAND);
    }
}